package com.web3toolsoft.commons.mybatis.conf;

import com.web3toolsoft.commons.mybatis.readwrite.DynamicDataSource;
import com.web3toolsoft.commons.mybatis.readwrite.DynamicDataSourcePlugin;
import com.web3toolsoft.commons.mybatis.readwrite.DynamicDataSourceTransactionManager;
...
public class ReadWriteDataSourceConfig extends AbstractDataSourceConfig {
    static final String PACKAGE = "com.web3toolsoft.commons.mybatis.sample.repository";
